...
class App extends React.Component {
  ...
  addGrouptoUser = group => {
    let newGroups = [...this.state.user.groups, group]
  ...
  render() {
    return (
        ...
        <Route exact path="/groups/:id" component={routerProps => <GroupShowPage user={this.state.user} addGrouptoUser={this.addGrouptoUser} {...routerProps}/>} />
